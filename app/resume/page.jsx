...
const MOCK_ANALYSIS = {
    ...
    education: { degree: "Bachelor's in Computer Science", school: 'XYZ University', year: '2024', gpa: '3.6' },
    experience: [
        {
            title: 'Frontend Developer Intern', company: 'Tech Corp', duration: '6 months',
            bullets: ['Worked on React components', 'Fixed bugs in the codebase', 'Attended daily standups']
        },
        {
            title: 'Web Developer', company: 'Freelance', duration: '1 year',
            bullets: ['Built 5 websites for clients', 'Used HTML CSS JavaScript', 'Managed client communication']
        }
    ],
    suggestions: [
        { type: 'Missing Skill', icon: '🎯', text: 'Add Machine Learning skills to boost Data Scientist match by 28%', points: 8 },
        { type: 'Weak Bullet', icon: '✏️', text: '"Worked on React components" → "Built 15+ reusable components reducing dev time by 40%"', points: 6 },
        { type: 'Formatting', icon: '📋', text: 'Add LinkedIn URL to contact section for better ATS ranking', points: 4 },
        { type: 'Achievement', icon: '🏆', text: 'Quantify your freelance work: "Delivered 5 client projects worth $X on time"', points: 5 },
        { type: 'Missing Skill', icon: '🎯', text: 'Add TypeScript — required in 78% of React job postings', points: 7 },
    ],
    careerMatches: [
        { career: 'Software Engineer', match: 78, missing: ['System Design', 'Algorithms', 'TypeScript'] },
        { career: 'Frontend Developer', match: 85, missing: ['TypeScript', 'Testing'] },
        { career: 'Data Scientist', match: 42, missing: ['ML', 'Statistics', 'TensorFlow'] },
        { career: 'DevOps Engineer', match: 35, missing: ['Docker', 'Kubernetes', 'AWS'] },
    ]
}
                            ...
                            <div>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '24px' }}>
                                    ...
                                    {[
                                        ...
                                        { label: 'Certifications', value: analysis?.certifications.length, color: '#a855f7' },
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                    ...
                                    <div style={{ background: '#0d1526', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '16px', padding: '24px' }}>
                                        ...
                                        <p style={{ color: '#64748b', fontSize: '13px' }}>{analysis?.education.year} · GPA {analysis?.education.gpa}</p>
                            ...
                            <div>
                                <div style={{ background: 'rgba(245,158,11,0.08)', border: '1px solid rgba(245,158,11,0.2)', borderRadius: '12px', padding: '16px 20px', marginBottom: '20px' }}>
                                    <p style={{ color: '#fbbf24', fontSize: '14px' }}>
                                        💡 Implementing all suggestions could raise your ATS score from <strong>72 → 91+</strong>
                                    </p>
                                </div>
